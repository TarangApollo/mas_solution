...
class RMAController extends Controller
{
    ...
    public function wl_index(Request $request)
    {
        ...
        if (Auth::User()->role_id == 2) {
            ...
            $rmsData = DB::table('rma')
                ...
                ->when($searchYear, function ($query, $year) {
                    $query->whereYear('rma.created_at', $year);
                })
                ->when($searchMonth, function ($query, $month) {
    ...
    public function rma_summary_info(Request $request, $id = null)
    {
        ...
        return view('wladmin.Wl_RMA.rma-summary-info', compact('rmaList', 'rmadetailList', 'Documents',));
    }
    ...
    public function rma_month_call_info(Request $request, $id = null)
    {
        if (Auth::User()->role_id == 2) {
            ...
            return view('wladmin.Wl_RMA.rma_month_call_info', compact('rmaList', 'rmadetailList', 'Documents'));
        } else {
            return redirect()->route('home');
        }
    }
