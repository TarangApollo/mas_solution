...
use App\Models\Role;
use Auth;
use Illuminate\Validation\Rule; // ✅ THIS LINE
    ...
    public function create(Request $request)
    {
        ...
        //    try {
                $request->validate([
                    ...
                    'strContact'   => 'required|digits_between:10,15',
                    'strEmailId'   => 'required|email|max:255|unique:users,email',
                    'strPassword'  => 'required',
                ], [
                    'strFirstName.required' => 'First name is required.',
                    'strLastName.required'  => 'Last name is required.',
                    'strContact.required'   => 'Mobile number is required.',
                    'strContact.digits_between' => 'Mobile number must be between 10 digits.',
                    //'strContact.unique'     => 'Mobile number already exists.',
                    'strEmailId.required'   => 'Email address is required.',
                    'strEmailId.email'      => 'Enter a valid email address.',
                    'strEmailId.unique'     => 'Email address already exists.',
                    'strPassword.required'  => 'Password is required.',
                    //'strPassword.min'       => 'Password must be at least 8 characters.',
                ]);
...
//            Rule::unique('users', 'mobile_number')->ignore($request->iUserId),
        ],
        'strEmailId' => [
            'required',
            'email',
            'max:255',
            Rule::unique('users', 'email')->ignore($request->iUserId),
        ],
    ], [
        'strFirstName.required' => 'First name is required.',
        'strLastName.required'  => 'Last name is required.',
        'strContact.required'   => 'Mobile number is required.',
        'strContact.digits_between' => 'Mobile number must be between 10 to 15 digits.',
//        'strContact.unique'     => 'Mobile number already exists.',
        'strEmailId.required'   => 'Email address is required.',
        'strEmailId.email'      => 'Enter a valid email address.',
        'strEmailId.unique'     => 'Email address already exists.',
  //      'iOEMCompanyId.required' => 'At least one company must be selected.',
    ]);
        // dd($request);
