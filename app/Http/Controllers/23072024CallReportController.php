...
class CallReportController extends Controller
{
    ...
    public function infoindex(Request $request, $id)
    {
        if (Auth::User()->role_id == 1) {
            ...
            $tickethistory[] = array("Status" => $ticketInfo->finalstatus, "Level" => "Level " . $ticketInfo->LevelId, "Date" => $ticketInfo->ComplainDate, "user" => $ticketInfo->first_name . " " . $ticketInfo->last_name);
