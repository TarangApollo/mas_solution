...
@section('content')
                                    ...
                                    <div class="row bg-orange bg-opacity-25 p-4">
                                        <div class="col-md-6 font-15">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                                    {{ $rmaList->strTicketUniqueID == 0 ? 'Other' : $rmaList->strTicketUniqueID ?? '-' }}
                                                </div>
                                                <div class="col-lg-4 col-md-12 col-xs-6 mb-2">Customer Company:
                                                </div>
                                                <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                                    {{ $rmaList->strCustomerCompany ?? '-' }}</div>
                                                <div class="col-lg-4 col-md-12 col-xs-6 mb-2">Customer Engineer:
                                                </div>
                                                <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                                    {{ $rmaList->strCustomerEngineer ?? '-' }}</div>
                                                        ...
                                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4"
                                                                        id="strMaterialReceivedDateDiv" style="display: none;">
                                                                        <div class="form-group" id="basicExample">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="js-example-basic-single"
                                                                                ...
                                                                                <option value="No Fault Found">No Fault
                                                                                    Found</option>
                                                                                <option value="Customer Liability">Customer
                                                                                    Liability
                                                                                </option>
                                                                                <option value="Product Failure">Product
                                                                                    Failure
                                                                                </option>
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="4" name="Additional_Testing_Comments"></textarea>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="js-example-basic-single"
                                                                                name="Additional_Factory_Status"
                                                                                id="" style="width: 100%;">
                                                                                <option label="Please Select"
                                                                                    value="">--
                                                                                    Select
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control py-6"
                                                                                type="file"
                                                                                name="Additional_Factory_strDocs[]"
                                                                                id="formFileMultiple" multiple
                                                                                accept=".pdf,.doc,.docx,.xlsx,.xls" />
                                                                        </div>
                                                                    </div> <!-- /.col -->
                                                                    <div class="col-lg-3 col-md-4">
                                                                        <div class="form-group">
                                                                            <label>Comments</label>
                                                                            <textarea class="form-control" rows="4" name="Additional_Factory_Comments"></textarea>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4">
                                                                        <div class="form-group">
                                                                            <label>Comments</label>
                                                                            <textarea class="form-control" rows="4" name="Additional_Cus_Comments"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div> <!-- /.row -->
                                                            </div><!-- /. accordion body -->
    ...
    <script>
       $("#strMaterialReceived").on("change", function(e) {
            ...
            if (getvalue == "Yes") {
                // Show the Material Received Date field and make it required
                $("#strMaterialReceivedDateDiv").css("display", "block");
                $("#strMaterialReceivedDate").attr("required", true);
            } else if (getvalue == "No") {
                // Hide the Material Received Date field and remove the required attribute
