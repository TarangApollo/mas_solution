                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="new-option clearfix">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    {{--  <label>isCanSwitchProfile</label> <br>  --}}
                                                                                    <br>
                                                                                    <input type="checkbox"
                                                                            ...
                                                                            <div class="col-md-4" id="oemCompanyDiv"
                                                                                style="display: none;">
                                                                                <div class="form-group">
                                                                                    <label>Select OEM
                                                                                        Company*</label>
                                                                            ...
                                                                            <div class="row" id="oemCompanylvl2Div"
                                                                                style="display: none">
                                                                                    ...
                                                                                    <div class="col-md-9 field_wrapper1">
                                                                                        ...
                                                                                        <div class="form-group d-flex">
                                                                                            <select
                                                                                                ...
                                                                                                onchange="getrole();"
                                                                                                name="iOEMCompanyAddMore[]"
                                                                                                id="iOEMCompanyAddMore"
                                                                                                style="width: 100%;"
                                                                                                required>
                                                                                                <option
                                                                                                    label="Please Select"
                                                                                            ...
                                                                                            <a href="javascript:void(0);"
                                                                                                class="btn btn-success add_button1 add-more"
                                                                                                title="Add Issue"><i
