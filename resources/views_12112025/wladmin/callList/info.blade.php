                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                @if ($additionalRecordingCount > 0)
                                    ...
                                    <div class="col-md-12 mb-4">
                                        ...
                                        @if ($addiData->aws_identifier != '' || $addiData->aws_identifier != null)
                                                <div class="row mt-4">
                                                    <div class="col-md-7">
                                                        <audio controls>
                                                            <source src="{{ asset('ticket_audio/') . '/' .$addiData->aws_identifier }}" type="audio/mpeg">
                                                            Your browser does not support the audio element.
                                                        </audio>
                                                    </div><!--/. md 7-->
                                                    <div class="col-md-4">
                                            ...
                                            @elseif ($addiData->recordUrl != '' || $addiData->recordUrl != null)
                                                <div class="row mt-4">
                                                    <div class="col-md-7">
                                                        <audio controls>
