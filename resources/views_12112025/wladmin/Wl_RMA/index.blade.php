                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single" style="width: 100%;" name="HFI">
                                                ...
                                                <!--</option>-->
                                                <option value="Open" {{ old('HFI', $HFI) == 'Open' ? 'selected' : '' }}>Open</option>
                                                <option value="Closed" {{ old('HFI', $HFI) == 'Closed' ? 'selected' : '' }}>Closed</option>
                                            </select>
                                        </div> <!-- /.form-group -->
                                    </div> <!-- /.col -->
                                    <div class="col-md-4">
                        ...
                        <table id="fresh-table" class="table">
                                ...
                                <tbody>
                                    @foreach ($groupedRmadetailList as $group)
                                        ...
                                        <tr>
                                            ...
                                            @if (in_array('QUANTITY', $selectedOptions))
                                                <td>
                                                    <span>{{ $group['strQuantity'] ?? '-' }}
                                                        <?php $TotalQuantity += $group['strQuantity'] ?? 0; ?>
                                                    </span>
                                                    @foreach ($details as $detail)
                                                        <br><span>{{ $detail->strQuantity ?? '-' }}
                                                            <?php $TotalQuantity += $detail->strQuantity ?? 0; ?>
                                                        </span>
                                                    @endforeach
                                                </td>
                                            @endif
                                    ...
                                    foreach ($selectedOptions as $option) {
                                        ...
                                        if($iCounter == 0){
                                            if (in_array('QUANTITY', $selectedOptions)) {
                                                echo "<td><strong>Total Quantity</strong></td>";
                                            } else {
                                                echo "<td></td>";
                                            }
                                        } else {
