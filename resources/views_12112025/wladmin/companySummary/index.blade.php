            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        <form class="was-validated p-4 pb-3" action="{{route('companysummary.index' )}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                ...
                <div class="fresh-table toolbar-color-orange">
                    <table id="fresh-table" class="table">
                        <thead>
                            ...
                            <th data-field="city" data-sortable="true">Company</th>
                            <th data-field="project" data-sortable="true">Count of Issues</th>
                            <th data-field="issues" data-sortable="true">Count of Customer</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('companysummary.info') }}" method="POST" style="display: inline-block;">
                                        <input type="hidden" name="_method" value="post">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="iCompanyId" value="{{ $ticket->iCompanyId }}">
            ...
            $('.mas-download').click(function(e) {
                ...
                if (table && table.length) {
                    $(table).table2excel({
                        ...
                        filename: "Company_summary_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                        fileext: ".xls",
                        exclude_img: true,
                        exclude_links: false,
