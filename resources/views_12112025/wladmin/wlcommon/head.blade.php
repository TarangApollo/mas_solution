<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('global/assets/css/style-wl.css') }}" /> -->
    <?php $string = str_replace(' ', '_', Session::get('CompanyName'));
    ...
    <!-- <link rel="stylesheet" type="text/css"
        href="{{ asset('global/assets/vendors/date-picker/daterangepicker.css') }}" /> -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('global/assets/vendors/date-picker/daterangepicker.css') }}" />
