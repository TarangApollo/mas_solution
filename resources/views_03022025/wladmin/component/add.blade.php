                                    ...
                                    <div class="tab-content clearfix">
                                        ...
                                        <div class="tab-pane fade in active" id="add-component">
                                            ...
                                            <form class="was-validated pb-3" name="frmparameter" id="frmparameter"
                                                action="{{ route('component.companycomponentstore') }}" method="post">
                                                @csrf
                                                            ...
                                                            <div id="collapseOne" class="accordion-collapse collapse show"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="new-option clearfix">
                                                                        <div class="row">
                                                                            <div class="col-lg-4 col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>System</label>
                                                                                    <input type="text" name="strSystem[]"
                                                                                        id="strSystem" class="form-control"
                                                                                        required="">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-4 col-md-12">
                                                                            ...
                                                                            <div class="col-lg-4 col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="js-example-basic-single"
                                                                                        ...
                                                                                        onchange="changeIsSubComponent(0);">
                                                                        ...
                                                                        <div class="col-md-12" id="divSubComponents0"
                                                                            style="display: none;">
                                                                                ...
                                                                                <table class="table table-bordered">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div
                                                                                                    class="col-md-9 field_wrapperNew">
                                                                                                    <div
                                                                                                        class="form-group d-flex">
                                                                                                        <input
                                                                                                            type="text"
                                                                                                            class="form-control"
                                                                                                            name="strSubComponent[0][]"
                                                                                                            id="strSubComponent">
                                                                                                        <a href="javascript:void(0);"
                                                                                                            class="btn btn-success add_button_new add-more"
                                                                                                            title="Add Option"><i
    ...
    <script type="text/javascript">
            ...
            $(addButton).click(function() {
                ...
                if (x < maxField) {
                    var fieldHTML = `<div class="accordion` + x + `" id="accordionExample">
                        ...
                        x + `" aria-expanded="true" aria-controls="collapseOne">
                                                                <span class="drag-icon pull-left">
                                                                    <i class="mas-arrow-move"></i>
                                                                </span>
                                                                New Option
                                                        ...
                                                        <div id="collapse` + x +
                        `" class="accordion-collapse collapse show" aria-labelledby="heading` + x +
                        `" data-bs-parent="#accordionExample">
                                                            <div class="accordion-body">
                                                                <div class="new-option clearfix">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4 col-md-12">
                                                                                <div class="form-group">
                                                                                    <label>Wish to add Sub
                                                                                        Component?</label>
                                                                                    <select class="js-example-basic-single" name="IsSubComponent[]" id="IsSubComponent_` +
                        x +
                        `" style="width: 100%;" required="" onchange="changeIsSubComponent(` + x +
                        `);">
                                                                            ...
                                                                            <div class="col-md-offset-8 col-lg-4 col-md-12">
                                                                                <button type="button" class="btn delete-option pull-right deleteDep" onclick="deleteDep(` +
                        x + `);" title="Delete Option">
                                                                                    <i class="mas-trash"></i>
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                    <div class="col-md-12" id="divSubComponents` + x +
                        `" style="display: none;">
                                                                        <div class="table-responsive">
                                                                            <table class="table table-bordered">
                                                                                <thead>
                        ...
                        `">
                                                                                                <div class="form-group d-flex">
                                                                                                    <input type="text" class="form-control" name="strSubComponent[` +
                        x +
                        `][]" id="strSubComponent">
                                                                                                    <a href="javascript:void(0);" class="btn btn-success add-more" onclick="add_button_new(` +
                        x + `);" title="Add Option"><i class="mas-plus-circle lh-normal"></i></a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
        ...
        function add_button_new(parentVal) {
            ...
            if (x < maxField) {
                ...
                <a href="javascript:void(0);" class="btn btn-danger pull-right add-more" onclick="remove_buttonNew(` +
                    parentVal + `,` + x + `)" title="Remove Option"><i class="mas-minus-circle lh-normal"></i>
                </a>
            </div>`; //New input field html
                x++; //Increment field counter
                $(wrapper).append(fieldHTML); //Add field html
        ...
        $('#submit').on("click", function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('component.companycomponentstore') }}",
                ...
                success: function(response) {
                    ...
                    if (response > 0) {
                        $('#loading').css("display", "none");
                        $('#save').val('0');
                        var url = "{{ route('component.create') }}";
