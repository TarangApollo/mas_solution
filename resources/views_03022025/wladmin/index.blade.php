...
@section('content')
    ...
    <div class="content-wrapper pb-0">
        ...
        <div class="row">
                ...
                <div class="card stretch-card grid-margin zoom">
                    <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                        <div class="row mb-1 w-115">
                            ...
                            <div class="col-4">
                                <img class="pull-right d-img" src="../global/assets/images/dashboard/calls.png"
                                    alt="calls">
                            </div>
                        </div>
                        <div class="text-left">
            ...
            <div class="col-lg col-md-6 pl-lg-0">
                <div class="card stretch-card grid-margin zoom">
                    <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                        <div class="row mb-1 w-115">
                            <div class="head">
                            ...
                            <div class="col-4">
                                <img class="pull-right" src="../global/assets/images/dashboard/ticket-closed.png"
                                    alt="ticket">
                            </div>
                        </div>
                        <!-- Total Tickets Form -->
                ...
                <div class="card stretch-card grid-margin zoom">
                    <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                        <div class="row mb-1 w-115">
                            ...
                            <div class="col-4">
                                <img class="pull-right" src="../global/assets/images/dashboard/products.png"
                                    alt="products">
                            </div>
                        </div>
                ...
                <div class="card stretch-card grid-margin zoom">
                    <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                        <div class="row mb-1 w-115">
                            ...
                            <div class="col-4">
                                <img class="pull-right" src="../global/assets/images/dashboard/company.png" alt="company">
                            </div>
                        </div>
                        <!-- Total Companies Form -->
                        <form action="{{ route('companysummary.index') }}" method="POST" id="totalCompanyForm" style="display: inline-block;">
                            <input type="hidden" name="_method" value="POST">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="text-left">
                                <h4 class="w-100 text-black-50">Total</h4>
                                <a href="javascript:void(0);" onclick="document.getElementById('totalCompanyForm').submit();">
                                    <h3 class="font-weight-bold d-flex align-items-center" id="NewCompany">0</h3>
                                </a>
                            </div>
                        </form>
                        <!-- New Companies Form -->
                        <form action="{{ route('companysummary.index') }}" method="POST" id="newCompanyForm" style="display: inline-block;">
                            ...
                            <div class="text-right">
                                ...
                                <a href="javascript:void(0);" onclick="document.getElementById('newCompanyForm').submit();">
                                    <h3 class="pull-right font-weight-bold d-flex align-items-center" id="TotalCompany">0</h3>
                                </a>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card stretch-card grid-margin zoom">
                    <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                        <div class="row mb-1 w-115">
                            ...
                            <div class="col-4">
                                <img class="pull-right" src="../global/assets/images/dashboard/users.png" alt="Customers">
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 stretch-card grid-margin">
                <div class="card zoom">
                    <div class="card-body">
                        <h4 class="card-title p-0 mt-0 mb-5 bg-transparent">RMA System Calls Analytics (Initially
                            display FY wise)</h4>
                ...
                <div class="card zoom">
                    <div class="card-body">
                        <h4 class="card-title p-0 mt-0 mb-5 bg-transparent">
                            RMA Analytics <br>
                            <small class="text-black-50 text-lowercase">Data displayed in % value</small>
                        </h4>
