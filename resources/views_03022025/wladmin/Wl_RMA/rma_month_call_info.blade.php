        ...
        <div class="content-wrapper pb-0">
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Rma-info</li>
                        <!--<li class="breadcrumb-item"><a-->
                        <!--        href="{{ route('Wl_RMA.rma_month_summary') }}">rma-month-summary-info</a></li>-->
                        <li class="breadcrumb-item"><a href="{{ route('Wl_RMA.rma_month_summary') }}">RMA Monthly Summary</a>
                        <!--<li class="breadcrumb-item"><a href="{{ route('Wl_RMA.rma_month_summary') }}">Summary</a>-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($rma_info->tableName != "rma")
                                                                {{ 'Additional RMA' }}
                                                            @endif
                                                            {{ $rma_info->strStatus }}</td>
                                                        <td>{{ \Carbon\Carbon::parse($rma_info->strEntryDate)->format('d-m-Y') }}
                                                            <br>
                                                            <small
                                                                ...
                                                                @if (count($documentFiles) > 0)
                                                                    <div class="row mx-1">
                                                                        <div class="col-md-12">
                                                                            <h4>Documents</h4>
                                                                            <div class="row mt-4">
                                                                                @foreach ($documentFiles as $index => $f_item)
                                                                                    @if ($f_item->Factory_strDocs)
                                                                                        @php
                                                                                            $extension = pathinfo(
                                                                                                $f_item->Factory_strDocs,
                                                                                                PATHINFO_EXTENSION,
                                                                                            );
                                                                                        @endphp
                                                                                        <div
                                                                                            class="col-md-3 col-sm-4 col-xs-6 gallery-box text-center">
                                                                                            @if ($extension == 'xls' || $extension == 'xlsx')
                                                                                                <a onclick="openDoc('{{ $f_item->rma_docs_id }}')">
                                                                                                    <img 
                                                                                                        src="{{ asset('global/assets/images/reference/photo/excel.jpg') }}"
                                                                                                        alt="{{ $f_item->Factory_strDocs }}">
                                                                                                </a>
                                                                                            @elseif($extension == 'doc' || $extension == 'docx')
                                                                                                <a onclick="openDoc('{{ $f_item->rma_docs_id }}')">
                                                                                                    <img 
