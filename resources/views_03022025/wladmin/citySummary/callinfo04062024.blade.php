            ...
            <div class="col-xl-12 stretch-card grid-margin">
                <div class="card">
                    <div class="card-body p-0">
                        <h4 class="card-title mt-0">Complaint Details for ID: {{str_pad($ticketInfo->iTicketId, 4, "0", STR_PAD_LEFT)}}</h4>
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped" data-role="content" data-plugin="selectable" data-row-selectable="true">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{date('d-m-Y',strtotime($ticketInfo->ComplainDate))}} <small class="position-static">{{date('H:i:s', strtotime($ticketInfo->ComplainDate))}}</small></td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>Resolved Date</td>
                                                ...
                                                @if($ticketInfo->ResolutionDate != '')
                                                    {{date('d-m-Y', strtotime($ticketInfo->ResolutionDate))}} <small class="position-static">{{date('H:i:s', strtotime($ticketInfo->ResolutionDate))}}</small>
                                                @endif
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <div class="table-responsive">
                                            <div class="row">
                                                <div class="col-md-12">
                                                  ...
                                                  <p>Latest Updated by: {{ $ticketInfo->TicketEditedBy ?? $ticketInfo->TicketCreatedBy }}</p>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    @if(count($ticketDetail)>0)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 gallery-box">
                                                    <div data-toggle="modal" data-target="#myModal">
                                                        <img src="{{asset('ticket_images/').'/'.$tDetail->DocumentName}}" alt="Image 1" data-target="#myCarousel" data-slide-to="{{$tDetail->iTicketDetailId}}">
                                                    </div>
                                                </div><!-- /.col -->
                                                ...
                                                <div class="col-md-2 gallery-box">
                                                    <div data-toggle="modal" data-target="#myModal">
                                                        <img src="{{asset('global/assets/images/customer/photo/video.jpg')}}" alt="Image 1" data-target="#myCarousel" data-slide-to="{{$tDetail->iTicketDetailId}}">
                                                        <!-- <iframe class="embed-responsive-item" src="{{asset('ticket_video/').'/'.$tDetail->DocumentName}}" allowfullscreen></iframe> -->
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div id="myCarousel" class="carousel slide">
                                                                <ol class="carousel-indicators">
                                                                    <?php $i = 1; ?>
                                                                    @foreach ($ticketDetail as $tDetail)
                                                                    <li data-target="#myCarousel" data-slide-to="{{$tDetail->iTicketDetailId}}" {{ $i==1 ? 'class="active"': ''; }}></li>
                                                                    <?php $i++; ?>
                                                                    @endforeach
                                                                </ol>
                                                                <div class="carousel-inner">
                                                                    ...
                                                                    <div class="carousel-item {{ ($i==1) ? 'active': ''; }}">
                                                                        <img src="{{asset('ticket_images/').'/'.$tDetail->DocumentName}}" class="d-block w-100" alt="Image 1">
                                                                    </div>
                                                                    @elseif($tDetail->DocumentType == 3)
                                                                    <div class="carousel-item {{ ($i==1) ? 'active': ''; }}">
                                                                        <div class="embed-responsive embed-responsive-16by9">
                                        ...
                                        <div class="embed-responsive-item">
                                                                        <video controls="" name="media"><source src="{{asset('ticket_video/').'/'.$tDetail->DocumentName}}" type="video/mp4"></video>
                                              </div>
                                                                        </div>
                                                                    </div>
                                                                    @endif
                                        ...
                                        <?php $iCounter = 1; ?>
                                            ...
                                            <td>{{$iCounter}}</td>
                                                ...
                                                <td>{{date('d-m-Y',strtotime($history['Date']))}}<br>
                                                    <small class="position-static">{{date('H:i:s', strtotime($history['Date']))}}</small>
                                                </td>
                                                <td>{{$history['user']}}</td>
                                            </tr>
                                            <?php $iCounter++; ?>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped" data-role="content" data-plugin="selectable"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ws-break">{{$Detail->strFirstName. " ". $Detail->strLastName}}
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    @if($Detail->recordUrl != '')
                                            ...
                                            @if(count($Detail->gallery)>0)
                                                <div class="col-12 ml-3">
                                                    <h4>Images & Videos by {{$Detail->first_name. "". $Detail->last_name}}</h4>
                                                    <!-- First row of images -->
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 gallery-box">
                                                            <div data-toggle="modal" data-target="#myModal1">
                                                                <img src="{{asset('ticket_images/').'/'.$gallery->DocumentName}}"
                                                                    alt="Image 1" data-target="#myCarousel1" data-slide-to="0">
                                                            </div>
                                                        </div><!-- /.col -->
