                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-4">
                                                            <div class="form-group">
                                                                <label>Select OEM Company</label>
                                                                <select class="js-example-basic-single" style="width: 100%;" name="OemCompannyId" id="OemCompannyId" Required>
        ...
        $(document).ready(function() {
            $('#iComplaintId').on('change', function() {
                if ($(this).val() === '0') {
                    ...
                    $('#strCustomerCompany, #strCustomerEngineer, #strProjectName,#strDistributor')
                        .removeAttr('readonly');
                        //.prop('disabled', false);
                       
                    $('#strDistributor').prop('disabled', false);
                } else {
                    // Add readonly to input fields #OemCompannyId,
                    $('#iRMANumber, #strCustomerCompany, #strCustomerEngineer, #strProjectName,#strDistributor')
                        .attr('readonly', true);
                        //.prop('disabled', true);
