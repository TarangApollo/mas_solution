<?php
    ...
    if($data['supportEmail'] != ""){
        ...
        $file = str_replace("#supportEmail","support@masolutions.co.in" ,$file);
    }
    if($data['ContactNo'] != ""){
        $file = str_replace("#companyAddress",$data['ContactNo'],$file);
    }else{
        $file = str_replace("#companyAddress",'IN (+91) 456 7891 224',$file);
    }
    echo $file;
 ?>
