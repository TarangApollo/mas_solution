...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper pb-0">
            ...
            $options = ['ID', 'NO', 'OUTCOME', 'STATUS', 'DATE', 'AUDIO', 'SERVICE', 'SYSTEM', 'PROJECTTYPE', 'OPEN LEVEL', 'CLOSE LEVEL', 'DURATION', 'ATTENDANT', 'ACTIONS'];
            $optionLabels = [
                'ID' => 'No',
                'NO' => 'Id',
                'OUTCOME' => 'Outcome',
                                ...
                                @foreach ($ticketList as $ticket)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            } else if($ticket->openLevel) {
                                                echo 'Level ' . $ticket->openLevel;
                                            } else {
                                                echo 'Level ' . $ticket->LevelId;
                                            }
                                            ?>
                                        </td>
                                        <?php } ?>
