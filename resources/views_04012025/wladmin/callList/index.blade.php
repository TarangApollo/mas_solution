                            ...
                            @foreach ($ticketList as $ticket)
                                <tr>
                                    ...
                                    <?php if (in_array('LEVEL', $selectedOptions)) {
                                        $Level = 0;
                                        if(isset($ticket->closelevel) && $ticket->closelevel != ""){
                                            $Level = $ticket->closelevel;
                                        } else if(isset($ticket->openLevel) && $ticket->openLevel != ""){
                                            $Level = $ticket->openLevel;
                                        } else {
                                            $Level = $ticket->LevelId;
                                        }
