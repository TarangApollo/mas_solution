                                                                ...
                                                                <div class="new-option clearfix">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Contact*</label>
                                                                                <input type="text" name="strContact" id="strContact" value="{{ $WlUser->strContact }}" class="form-control" maxlength="10" minlength="10" required="" onkeypress="return isNumber(event)">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
