                                    ...
                                    <div class="" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{ route('companyclient.basicinfostore') }}" method="post">
                                            ...
                                            <input type="hidden" name="save" id="save" value="0">
                                               <input type="hidden" name="iCompanyClientId" id="iCompanyClientId" value="{{$id}}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="CompanyName[]" id="CompanyName" class="form-control" required="" value="{{$id!=0? $CompanyClient->CompanyName:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Company Email ID* </label>
                                                                                <input type="email" name="email[]" id="email" class="form-control" required="" value="{{$id!=0? $CompanyClient->email:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Owner</label>
                                                                                <input type="text" name="owner[]" id="Owner" class="form-control" value="{{$id!=0? $CompanyClient->owner:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Owner Email ID* </label>
                                                                                <input type="email" name="owneremail[]" id="owneremail" class="form-control" value="{{$id!=0? $CompanyClient->owneremail:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Owner Phone</label>
                                                                                <input type="text" name="ownerphone[]" id="contact" class="form-control" maxlength="10" onkeypress="return isNumber(event)" value="{{$id!=0? $CompanyClient->ownerphone:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Address</label>
                                                                                <input type="text" name="address[]" id="address" class="form-control" value="{{$id!=0? $CompanyClient->address:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="js-example-basic-single" name="iStateId[]" id="iStateId0" style="width: 100%;" onchange="getCity(0);">
                                                                                    ...
                                                                                    <option value="{{ $state->iStateId }}" {{($id!=0 && $CompanyClient->iStateId == $state->iStateId )? 'selected':''}}>{{ $state->strStateName }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="js-example-basic-single" name="iCityId[]" id="iCityId" style="width: 100%;">
                                                                                    ...
                                                                                    <option value="{{ $cities->iCityId }}" {{( $id!=0 && $CompanyClient->iCityId == $cities->iCityId)? 'selected':''}}>{{ $cities->strCityName }} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="branchOffice[]" id="branchOffice" class="form-control" value="{{$id!=0? $CompanyClient->branchOffice:''}}" >
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="js-example-basic-single" name="iCompanyClientProfileId[]" id="iCompanyClientProfileId" style="width: 100%;">
                                                                                    ...
                                                                                    <option value="{{ $ClientProfile->iCompanyClientProfileId }}" {{($id!=0 && $CompanyClient->owner == $state->iStateId )? 'selected':''}}>{{ $ClientProfile->strCompanyClientProfile }} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                ...
                                                <div class="new-option clearfix">
                                                    ...
                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Owner Phone</label>
                                                                                <input type="text" name="contact[]" id="contact" class="form-control"  maxlength="10" onkeypress="return isNumber(event)" >
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
