                                        ...
                                        <div id="role_information" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <ul class="accordion-tab nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('companyclient.technicaledit',$CompanyClientProfile->iCompanyClientId) }}">Technical Person</a>
                                                    </li>
                                                    <li>
                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    <div class="tab-pane fade in active" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{ route('companyclient.salesupdate') }}" method="post">
...
<script>
    ...
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('companyclient.salesupdate')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    var url = "{{route('companyclient.salesedit',':id')}}";
    ...
    function deletesales(id) {
        ...
        var url = "{{route('companyclient.salesdelete',':id')}}";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    url = "{{route('companyclient.salesedit',':id')}}";
