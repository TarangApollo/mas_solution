                                        ...
                                        <div id="role_information" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <ul class="accordion-tab nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('companyclient.basicinfocreate',$id) }}">Basic Information</a>
                                                    </li>
                                                    <li class="active">
                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    ...
                                    <div class="" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{ route('companyclient.salesstore') }}" method="post">
                                            @csrf
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('companyclient.salesstore')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    var url = "{{route('companyclient.salescreate',':id')}}";
