                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    <div class="tab-pane fade in active" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('distributor.technicalupdate')}}" method="post">
                                                                ...
                                                                <div class="new-option clearfix">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Phone*</label>
                                                                                <input type="text" name="phone[]" id="phone_{{$icounter}}" class="form-control" required maxlength="10" minlength="10" onkeypress="return isNumber(event)" value="{{$salesList->technicalPersonNumber}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
...
<script>
    ...
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('distributor.technicalupdate')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    var url = "{{route('distributor.technicaledit',':id')}}";
    ...
    function deletesales(id) {
        ...
        var url = "{{route('distributor.technicaldelete',':id')}}";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    url = "{{route('distributor.technicaledit',':id')}}";
