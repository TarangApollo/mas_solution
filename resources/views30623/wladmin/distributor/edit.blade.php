                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="distributorPhone" id="distributorPhone" class="form-control" maxlength="10" minlength="10"  value="{{ $Distributor->distributorPhone }}" onkeypress="return isNumber(event)">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
