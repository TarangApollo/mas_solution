                                        ...
                                        <div id="role_information" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <ul class="accordion-tab nav nav-tabs">
                                                    <!-- <li>
                                                        <a href="{{ route('distributor.create') }}">Company Profile</a>
                                                    </li> -->
                                                    <li>
                                                        <a href="{{ route('distributor.edit',$Distributor->iDistributorId) }}">Basic Information</a>
                                                    </li>
                                                    <li class="active">
                                                        <a href="#sales" data-toggle="tab">Sales Person</a>
                                                    </li>
                                                    <li>
                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    <div class="tab-pane fade in active" id="account">
                                        <h3 class="tab-content-title">Sales Person</h3>

                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{ route('distributor.salesupdate') }}" method="post">
                                            <input type="hidden" name="iCompanyClientId" id="iCompanyClientId" value="{{ $Distributor->iDistributorId}}">
                                            <input type="hidden" name="company_id" id="company_id" value="{{ $Distributor->iCompanyId }}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Name*</label>
                                                                                <input type="text" name="name[]" id="name_{{$icounter}}" class="form-control" required="" value="{{$salesList->salesPersonName}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Phone*</label>
                                                                                <input type="text" name="phone[]" id="phone_{{$icounter}}" class="form-control" required maxlength="10" minlength="10" onkeypress="return isNumber(event)" value="{{$salesList->salesPersonNumber}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Email ID* </label>
                                                                                <input type="email" name="email[]" id="email_{{$icounter}}" class="form-control" required="" value="{{$salesList->salesPersonEmail}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-offset-8 col-lg-4 col-md-12">
                                                                            <input type="hidden" name="salesId[]" id="salesId_{{$icounter}}" value="{{$salesList->iSalesId}}" />
...
<script>
    ...
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('distributor.salesupdate')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    ...
                    $('#save').val('0');
                    var url = "{{route('distributor.salesedit',':id')}}";
    ...
    function deletesales(id) {
        ...
        var url = "{{route('distributor.salesdelete',':id')}}";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    url = "{{route('distributor.salesedit',':id')}}";
                                        ...
                                        <div class="new-option clearfix">
                                            ...
                                            <div class="col-md-4">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>Phone</label>
                                                                        <input type="text" name="phone[]" id="phone" class="form-control"  maxlength="10" minlength="10" required onkeypress="return isNumber(event)" >
                                                                    </div> <!-- /.form-group -->
                                                                </div> <!-- /.col -->
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-offset-8 col-lg-4 col-md-12">
                                                    ...
                                                    <input type="hidden" name="salesId[]" id="salesId_` + x + `" value="0" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
