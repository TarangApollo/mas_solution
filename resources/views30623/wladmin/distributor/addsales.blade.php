                                        ...
                                        <div id="role_information" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <ul class="accordion-tab nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('distributor.create',$id) }}">Basic Information</a>
                                                    </li>
                                                    <li class="active">
                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    ...
                                    <div class="" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{ route('distributor.salesstore') }}" method="post">
                                            @csrf
                                                                ...
                                                                <div class="new-option clearfix">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Phone*</label>
                                                                                <input type="text" name="phone[]" id="phone" class="form-control" required maxlength="10" minlength="10" onkeypress="return isNumber(event)">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('distributor.salesstore')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $('#save').val('0');
                    var url = "{{route('distributor.salescreate',':id')}}";
