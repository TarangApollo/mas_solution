        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <form class="was-validated p-4 pb-3" action="{{ route('distributor.index') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Distributor Name</label>
                                    <input type="text" class="form-control" value="{{ $search_name ?? '' }}" name="search_name" >
                                </div> <!-- /.form-group -->
                            </div> <!-- /.col -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Distributor Contact</label>
                                    <input type="text" class="form-control" value="{{ $search_contact ?? '' }}" name="search_contact" >
                                </div> <!-- /.form-group -->
                            </div> <!-- /.col -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Distributor Email ID</label>
                                    <input type="email" class="form-control" value="{{ $search_email ?? '' }}" name="search_email" >
                                </div> <!-- /.form-group -->
                            </div> <!-- /.col -->
                            <div class="col-md-4">
                                <div class="form-group">
        ...
        $('.mas-download').click(function(e) {
            ...
            if (table && table.length) {
                $(table).table2excel({
                    ...
                    filename: "Distributors" + new Date().toISOString().replace(/[\-\:\.]/g, "") +
                        ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
