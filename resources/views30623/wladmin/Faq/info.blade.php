                                                                    ...
                                                                    @foreach ($faqVideos as $video)
                                                                        <div class="carousel-item active">
                                                                            <div  class="embed-responsive embed-responsive-16by9">
                                                                                <!-- <iframe class="embed-responsive-item" src="{{ asset('FaqDocument/Video/') . '/' . $video->strFileName }}"
                                                                                    allowfullscreen></iframe> -->
                                                                                <div class="embed-responsive-item">
                                                                                    <video controls="" name="media"><source src="{{ asset('FaqDocument/Video/') . '/' . $video->strFileName }}" type="video/mp4"></video>
                                                                                </div>
                                                                            </div>
