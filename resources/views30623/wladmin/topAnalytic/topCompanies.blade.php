                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    ...
                                    <div class="tab-pane fade in active" id="add-component">
                                        <h3 class="tab-content-title">Top Companies</h3>
                                            <div class="row">    
                                                <!--table div start-->
                                                <div class="col-md-12">                                
                                                    <div class="fresh-table toolbar-color-orange">
                                                        <table id="fresh-table" class="table" data-url="{{ route('topanalytic.topCompanies') }}">
                                                            <thead>
        ...
        $('.mas-download').click(function(e) {
            ...
            if (table && table.length) {
                $(table).table2excel({
                    ...
                    filename: "Top_Companies_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: false,
