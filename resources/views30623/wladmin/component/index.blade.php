        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <form class="was-validated p-4 pb-3" action="{{ route('component.index') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Select System*</label>
                                    <select class="js-example-basic-single" name="search_system" id="search_system" style="width: 100%;" required>
                                        <option label="Please Select" value="">-- Select --
                                        </option>
                                        @foreach($systems as $system)
                                        <option value="{{ $system->iSystemId }}" @if($search_system == $system->iSystemId) {{ 'selected' }} @endif>{{ $system->strSystem }} </option>
                                        @endforeach
                                    </select>
                                </div> <!-- /.form-group -->
                            </div> <!-- /.col -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" name="search_component" id="search_component" style="width: 100%;" required>
                                        ...
                                        <option value="{{ $component->iComponentId }}" @if($search_component == $component->iComponentId) {{ 'selected' }} @endif >{{ $component->strComponent }}</option>
                                        @endforeach
                                    </select>
                                </div> <!-- /.form-group -->
                            </div> <!-- /.col -->
                ...
                <table id="fresh-table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('component.edit',$component->iComponentId ) }}" title="Edit" class="table-action">
                                    <i class="mas-edit"></i>
                                </a>

                                <form action="{{ route('component.componentdelete', $component->iComponentId) }}" method="POST" onsubmit="return confirm('Are you Sure You wanted to Delete?');" style="display: inline-block;">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <a href="#" title="Delete" class="table-action">
                                        <button type="submit" style="border: none;"><i class="mas-trash"></i></button>
                                    </a>
                                </form>
                            </td>
                        </tr>
