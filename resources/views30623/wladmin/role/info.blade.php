                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge badge-success">{{$user->strFirstName. ' '. $user->strLastName}}</span>
                                                    @endforeach
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <br>
                                                    <span class="badge badge-secondary">{{$submenulist['name']}}</span>
                                                    @endif
                                                    @endforeach
                                                    <br>
                                                    @endif
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{date('d-m-Y',strtotime($log->strEntryDate))}}<br>
                                                    <small class="position-static">{{date('H:i:s',strtotime($log->strEntryDate))}}</small>
                                                </td>
                                                <td>{{$log->actionBy}}</td>
                                            </tr>
                                            <?php $icounter++; ?>
