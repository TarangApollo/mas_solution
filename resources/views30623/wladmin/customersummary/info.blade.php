            ...
            <div class="col-xl-12 stretch-card grid-margin">
                <div class="card">
                    <div class="card-body p-0">
                        <h4 class="card-title mt-0">CALL LIST FOR: {{ (!empty($ticketData) && $ticketData->strCustomerName != "") ? $ticketData->strCustomerName : "" }} {{ (isset($strComponent) && $strComponent != "") ? ",".$strComponent : "" }} {{ (isset($strSubComponent) && $strSubComponent != "") ? ",".$strSubComponent : "" }} </h4>
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <table class="table table-striped" data-role="content" data-plugin="selectable" data-row-selectable="true">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $iCounter }}</td>
                                                <td>
                                                    <a href="{{ route('customersummary.callinfo',$ticket->iTicketId) }}">
