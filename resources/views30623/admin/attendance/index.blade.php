                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('attendance.info') }}" method="POST"
                                        ...
                                        <input type="hidden" name="daterange" id="strdaterange_{{ $Attendent->iCallAttendentId }}" value="">
                                        <a href="#" title="Info" class="table-action">
                                            <button type="submit" onclick="return setSelectedDateRange({{ $Attendent->iCallAttendentId }});"
...
<script>
function setSelectedDateRange(iCallAttendentId) {
    $("#strdaterange_"+iCallAttendentId).val($("#datepicker").val());
}
