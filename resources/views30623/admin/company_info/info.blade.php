                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="Pincode"
                                                            id="Pincode" value="{{ $CompanyInfo->Pincode ?? '' }}" maxlength="6" onkeypress="return isNumber(event)">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="Phone" id="Phone"
                                                            value="{{ $CompanyInfo->Phone ?? '' }}" maxlength="10" onkeypress="return isNumber(event)">
                                                    </div> <!-- /.form-group -->
                                                </div> <!-- /.col -->
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ContactNo"
                                                            id="ContactNo" value="{{ $CompanyInfo->ContactNo ?? '' }}" maxlength="10" onkeypress="return isNumber(event)">
