                        ...
                        <div class="col-lg-9 col-md-8">
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('company.store')}}" method="post">
                                        <input type="hidden" name="company_id" id="company_id" value="{{ $Company->iCompanyId ?? 0 }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="strOEMCompanyName" id="strOEMCompanyName" value="{{ $Company->strOEMCompanyName ?? '' }}" class="form-control" required="required" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="strOEMCompanyId" id="strOEMCompanyId" value="{{ $Company->strOEMCompanyId ?? '' }}" class="form-control" readonly />
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $Company->ContactPerson ?? '' }}" name="ContactPerson" id="ContactPerson" required="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Mail ID*</label>
                                                        <input type="email" class="form-control" value="{{ $Company->EmailId ?? '' }}" name="EmailId" id="EmailId" required="" >
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $Company->ContactNo ?? '' }}" name="ContactNo" id="ContactNo" maxlength="10" onkeypress="return isNumber(event)" required="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $Company->Address1 ?? '' }}" name="Address1" id="Address1" required="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $Company->Address2 ?? '' }}" name="Address2" id="Address2" required="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $Company->Address3 ?? '' }}" name="Address3" id="Address3">
                                                    </div> <!-- /.form-group -->
                                                </div> <!-- /.col -->
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Postcode*</label>
                                                        <input type="text" class="form-control" value="{{ $Company->Pincode ?? '' }}" name="Pincode" id="Pincode" required="" maxlength="6" onkeypress="return isNumber(event)">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single" style="width: 100%;" name="iStateId" id="iStateId" onchange="getCity();" required>
                                                            <option label="Please Select" value="">--
                                                                Select --</option>
                                                            @foreach($statemasters as $state)
                                                            <option value="{{ $state->iStateId }}" @if(isset($Company->iStateId) && $Company->iStateId == $state->iStateId) {{ 'selected' }} @endif>{{ $state->strStateName }}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single" style="width: 100%;" name="iCityId" id="iCityId" required>
                                                            <option label="Please Select" value="">--
                                                                Select --</option>
                                                            @foreach($citymasters as $cities)
                                                            <option value="{{ $cities->iCityId }}" @if(isset($Company->iCityId) && $Company->iCityId == $cities->iCityId) {{ 'selected' }} @endif>{{ $cities->strCityName }} </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $Company->strGSTNo ?? '' }}" name="strGSTNo" id="strGSTNo" required="" minlength="15" maxlength="15">
                                                        <span id="errstrGSTNo" class="text-danger"></span>
                                                    </div> <!-- /.form-group -->
                                                </div> <!-- /.col -->
                                            </div>
                                            <div class="row">
                                                <div class="preloader" id="loading" style="display: none;" role="status">
                                                    <img src="{{ asset('images/loader.gif')}}" >
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <button type="button" class="btn btn-default text-uppercase mt-4" onClick="checkclose();">
                                                        Clear
                                                    </button>
                                                ...
                                                <div class="col-md-6 d-flex justify-content-end">
                                                    ...
                                                    <button type="submit" value="saveSubmit" name="savesubmit" class="btn btn-success text-uppercase mt-4" id="savesubmit" onclick="validateForm()">
                                                        Save & Exit
                                                    </button>
                                                </div>
                                            </div>
