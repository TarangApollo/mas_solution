                                ...
                                <div class="accordion-box-content">
                                    <div class="tab-content clearfix">
                                        ...
                                        <div class="tab-pane fade in active" id="competency">
                                            ...
                                            <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('company.callcompetencystore')}}" method="post">
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('company.callcompetencystore')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $("#successalert").show();
                    $("#msgdata").html("<strong>Success !</strong> Call Competency Created Successfully.");
                    ...
                    // url = url.replace('?', '/');
                    var url = "{{route('company.call-competency',':company_id')}}";
                    url = url.replace(':company_id', company_id);
                    url = url.replace('?', '/');
