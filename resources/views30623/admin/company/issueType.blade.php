                        ...
                        <div class="col-lg-9 col-md-8">
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    <!--issue type form starts-->
                                    <div class="tab-pane fade in active" id="issue-type">
                                        <h3 class="tab-content-title">Issue Type</h3>
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('company.issuetypestore')}}" method="post">
                                                                    ...
                                                                    <td>
                                                                        <div class="col-md-9 field_wrapper">
                                                                            ...
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iSSueTypeId[]" value="0">
                                                                            ...
                                                                            @if($iCounter == 0)
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iSSueTypeId[]" value="{{ $issuetype->iSSueTypeId ?? 0 }}">
                                                                                <input type="text" class="form-control" name="field_name[]" value="{{ $issuetype->strIssueType }}">
                                                                                <a href="javascript:void(0);" class="btn btn-success add_button add-more" title="Add Issue"><i class="mas-plus-circle lh-normal"></i></a>
                                                                            </div>
                                                                            @else
                                                                            <div class="form-group d-flex">
                                                                            ...
                                                                            @endif
                                                                            <!-- <div class="form-group d-flex">
                                                                                    <input type="text" class="form-control" value="Wiring">
                                                                                    <a href="javascript:void(0);" class="btn btn-danger remove_button add-more" title="Delete Issue"><i class="mas-minus-circle lh-normal"></i></a>
                                                                                </div>

                                                                                <div class="form-group d-flex">
                                                                                    <input type="text" class="form-control" value="Product Feature">
                                                                                    <a href="javascript:void(0);" class="btn btn-danger remove_button add-more" title="Delete Issue"><i class="mas-minus-circle lh-normal"></i></a>
                                                                                </div> -->
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('company.issuetypestore')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $("#successalert").show();
                    $("#msgdata").html("<strong>Success !</strong> Issue Type Created Successfully.");
                    ...
                    // url = url.replace('?', '/');
                    var url = "{{route('company.issue-type',':company_id')}}";
                    url = url.replace(':company_id', company_id);
                    url = url.replace('?', '/');
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var fieldHTML =
            '<div class="form-group d-flex"><input type="hidden" name="iSSueTypeId[]" value="0"><input type="text" class="form-control" name="field_name[]" value=""/><a href="javascript:void(0);" class="btn btn-danger remove_button pull-right add-more" title="Remove Option"><i class="mas-minus-circle lh-normal"></i></a></div>'; //New input field html
