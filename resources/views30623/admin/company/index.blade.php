                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" name="search_company"  style="width: 100%;" required>
                                        <option label="Please Select" value="">-- Select --</option>
                                        @foreach($CompanyMaster as $Companies)
                                        <option value="{{ $Companies->iCompanyId }}" @if(isset($search_company) && $search_company== $Companies->iCompanyId) {{ 'selected' }}@endif>{{ $Companies->strOEMCompanyName }}</option>
                                        @endforeach
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single" name="search_status" style="width: 100%;" required>
                                        <option label="Please Select" value="">-- Select --</option>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="iStatus" id="iStatus" value="Active" onchange="updateStatus(<?= $Companies->iStatus ?>,<?= $Companies->iCompanyId ?>);" data-toggle="toggle" data-width="90" checked>
                                @else
                                <input type="checkbox" name="iStatus" id="iStatus" value="Inactive" onchange="updateStatus(<?= $Companies->iStatus ?>,<?= $Companies->iCompanyId ?>);" data-toggle="toggle" data-width="90">
                                @endif
                            </td>
                            ...
                            <td>
                                <a href="{{ route('company.create', $Companies->iCompanyId)}}" title="Edit" class="table-action">
                                    <i class="mas-edit"></i>
                                </a>
                                <a href="{{ route('company.info',$Companies->iCompanyId) }}" title="Info" class="table-action">
        ...
        $('.mas-download').click(function(e) {
            ...
            if (table && table.length) {
                $(table).table2excel({
                    ...
                    filename: "company" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
