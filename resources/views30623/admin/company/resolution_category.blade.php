                        ...
                        <div class="col-lg-9 col-md-8">
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    ...
                                    <!--Resolution Category start-->
                                    <div class="tab-pane fade in active" id="res-category">
                                        <h3 class="tab-content-title">Resolution Category</h3>
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('company.resolutioncategorycreatestore')}}" method="post">
                                            ...
                                            <div class="row">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="col-md-9 field_wrapper">
                                                                            @if($resolutionCategories->isEmpty())
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iResolutionCategoryId[]" value="0">
                                                                                <input type="text" class="form-control" name="field_name[]">
                                                                                <a href="javascript:void(0);" class="btn btn-success add_button add-more" title="Add Category"><i class="mas-plus-circle lh-normal"></i></a>
                                                                            </div>
                                                                            @else
                                                                            <?php $iCounter = 0; ?>
                                                                            ...
                                                                            @if($iCounter == 0)
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iResolutionCategoryId[]" value="{{ $resolutionCategory->iResolutionCategoryId ?? 0 }}">
                                                                                <input type="text" class="form-control" name="field_name[]" value="{{ $resolutionCategory->strResolutionCategory }}">
                                                                                <a href="javascript:void(0);" class="btn btn-success add_button add-more" title="Add Category"><i class="mas-plus-circle lh-normal"></i></a>
                                                                            </div>
                                                                            @else
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iResolutionCategoryId[]" value="{{ $resolutionCategory->iResolutionCategoryId ?? 0 }}">
                                                                                <input type="text" class="form-control" name="field_name[]" value="{{ $resolutionCategory->strResolutionCategory }}">
                                                                                <a href="javascript:void(0);" class="btn btn-danger remove_button add-more" title="Delete Category"><i class="mas-minus-circle lh-normal"></i></a>
                                                                            </div>
                                                                            @endif
                                                                            <?php $iCounter++; ?>
                                                                            @endforeach
                                                                            ...
                                                                            <!-- <div class="form-group d-flex">
                                                                                ...
                                                                                <div class="form-group d-flex">
                                                                                    <input type="text" class="form-control" value="Category 3">
                                                                                    <a href="javascript:void(0);" class="btn btn-danger remove_button add-more" title="Delete Category"><i class="mas-minus-circle lh-normal"></i></a>
                                                                                </div> -->
                                                                        </div>
                                                                    </td>
                                                ...
                                                <!--/.col-md-12 Resolution Category list-->
                                            </div>
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('company.resolutioncategorycreatestore')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $("#successalert").show();
                    $("#msgdata").html("<strong>Success !</strong> Resolution Category Created Successfully.");
                    ...
                    // url = url.replace('?', '/');
                    var url = "{{route('company.res-categorycreate',':company_id')}}";
                    url = url.replace(':company_id', company_id);
                    url = url.replace('?', '/');
