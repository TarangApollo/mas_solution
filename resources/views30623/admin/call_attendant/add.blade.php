                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    <div class="tab-pane fade in active" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('call_attendant.store')}}" method="post">
                                                                ...
                                                                <div class="new-option clearfix">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Contact*</label>
                                                                                <input type="text" name="strContact[]" id="strContact" class="form-control" maxlength="10" minlength="10" required="" onkeypress="return isNumber(event)">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response > 0) {
                        $('#loading').css("display", "none");
                        $("#successalert").show();
                        $("#msgdata").html("<strong>Success !</strong> Call Attendant Created Successfully.");
                        $('#save').val('0');
                            ...
                            <div class="new-option clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Contact*</label>
                                            <input type="text" name="strContact[]" id="strContact" class="form-control" required="" maxlength="10" onkeypress="return isNumber(event)">
                                        </div> <!-- /.form-group -->
                                    </div> <!-- /.col -->
                                    <div class="col-md-4">
                                        <div class="form-group">
