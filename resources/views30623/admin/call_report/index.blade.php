                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single" style="width: 100%;" name="CallOutcome" id="CallOutcome">
                                            <option label="Please Select" value="">-- Select --</option>
                                            <option value="answered" {{ (isset($postarray['CallOutcome']) && $postarray["CallOutcome"] == 'answered') ? 'selected' : '' }}>Answered</option>
                                            <option value="missed" {{ (isset($postarray['CallOutcome']) && $postarray["CallOutcome"] == 'missed') ? 'selected' : '' }}>Missed</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-single" style="width: 100%;" name="exeId" id="exeId">
                                            <option label="Please Select" value="">-- Select --</option>
                        ...
                        <tbody>
                            ...
                            @foreach($ticketList as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('call_report.info',$ticket->iTicketId) }}" title="Info" class="table-action">
