                                    ...
                                    <div class="row bg-orange bg-opacity-25 p-4">
                                        <div class="col-md-6 font-15">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                                    <strong>{{ str_pad($ticketInfo->iTicketId, 4, '0', STR_PAD_LEFT) }}</strong>
                                                </div>
                                        ...
                                        <div class="col-md-6 font-15">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-12 col-xs-6 mb-2">Resolution Category:</div>
                                                <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                                ...
                                                <div class="col-lg-8 col-md-12 col-xs-6 mb-2">{{ $ticketInfo->ticketName }}
                                                </div>
                                    ...
                                    @if (count($ticketLogs) > 0)
                                        @foreach ($ticketLogs as $Detail)
                                            <div class="row bg-orange bg-opacity-25 p-4">
                                                ...
                                                <div class="col-md-6 font-15">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-12 col-xs-6 mb-2">Resolution Category:
                                                        </div>
                                                        <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                        ...
                                        <div class="col-sm-12">
                                            <form class="was-validated" id="frmparameter"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="js-example-basic-single" style="width: 100%;"
                                                                ...
                                                                <option value="3"
                                                                    {{ $ticketInfo->finalStatus == 1 ? 'selected' : '' }}>
                                                                    Reopen</option>
                                                    ...
                                                    <div class="col-md-4" id="iLevel2CallAttendentIdDiv" {{$ticketInfo->LevelId == 2 ? "style=display:block;":"style=display:none;" }} >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single" style="width: 100%;"
                                                            ...
                                                            <option value="{{ $exe->iCallAttendentId }}">{{ $exe->strFirstName." ".$exe->strLastName  }}</option>
                                                            @endforeach
                                                            @endif
                                                        </select>
                                                    </div> <!-- /.form-group -->
                                                ...
                                                <input type="hidden" name="oldStaus" value="{{ $ticketInfo->finalStatus == 1 ? '3' : $ticketInfo->finalStatus }}">
                                                <input type="hidden" name="oldStausDatetime" value="{{ $ticketInfo->finalStatus == 1 ? date('Y-m-d H:i:s') : '' }}">
