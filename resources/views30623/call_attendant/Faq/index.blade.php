                                ...
                                <div class="card-body p-0">
                                    ...
                                    <form class="was-validated p-4 pb-3" action="" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="searchText" value="{{ isset($postarray['searchText'])  ? $postarray['searchText'] : '' }}" />
                                                </div>
                                            </div> <!-- /.col -->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <input type="submit" class="btn btn-fill btn-success text-uppercase mt-3"
                                            value="Search" name="searchFaq">
                                        <a class="btn btn-fill btn-success text-uppercase mt-3"
                                ...
                                @if (count($Faqs) > 0)
                                    @foreach ($Faqs as $faq)
                                        <div class="panel panel-default">
                                            <div class="panel-heading bg-white" role="tab"
                                                id="heading{{ $faq->iFAQId }}">
