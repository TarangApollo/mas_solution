    ...
    <div class="container">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="{{ route('callattendantAdmin.dashboard') }}">
                <img src="{{ asset('global/assets/images/logo.png') }}" alt="logo" />
            </a>
                ...
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                        ...
                        <div class="nav-profile-img">
                            <img src="{{ (auth()->user()->photo) ? asset('/CallAttendantProfilePhoto/' . $photo) : asset('global/assets/images/user_icon.jpeg'); }}" alt="image" />
                        </div>
                        <div class="nav-profile-text">
                            <p class="text-black font-weight-semibold m-0"> {{auth()->user()->first_name ." " . auth()->user()->last_name}}  </p>
                    ...
                    <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                        ...
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                            <i class="mas-log-out me-2 text-orange"></i> Signout </a>
                    </div>
                </li>
            </ul>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{ route('profile.logoutlog') }}"
