                        ...
                        <div class="header-right d-flex flex-wrap mt-md-2 mt-lg-0">
                            <div class="d-flex align-items-center">
                                <a class="border-0" href="#">
                                    <p class="m-0 pr-8">Reference Documents</p>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mt-5">
                            <div class="card-body p-0">
                                ...
                                <form class="was-validated p-4 pb-3" action="" method="post">
                                    ...
                                    <input type="submit" class="btn btn-success text-uppercase mt-3 mr-2"
                                        value="Search" name="searchRef">
                                    <input type="button" class="btn btn-fill btn-default text-uppercase mt-3"
                                        onclick="window.location='{{ route('callattendantreference.index') }}'" value="Clear">
                                </form>
                            </div>
                        </div>
                        <!--card end-->
