    ...
    <div class="container-fluid page-body-wrapper">
        <div class="main-panel">
            <div class="content-wrapper pb-0">
                ...
                $options = ['NO', 'ID', 'STATUS', 'CONTACT NAME', 'CONTACT NO', 'OEM COMPANY', 'COMPANY NAME', 'SYSTEM', 'COMPONENT', 'SUB COMPONENT', 'SOLUTION TYPE', 'COMPLAINT DATE', 'RESOLVED DATE', 'ISSUE', 'ATTENDANT', 'ACTIONS'];
                $optionLabels = [
                    'NO' => 'No',
                    'ID' => 'ID',
                    'STATUS' => 'Status',
