...
@section('content')
    ...
    <div class="content-wrapper pb-0">
        ...
        <div class="row">
            ...
            @if(!empty($CompanyMaster) && $CompanyMaster->iAllowedCallCount == 1)
                <div class="col-lg-3 col-md-6 pr-lg-0">
                    <div class="card stretch-card mb-3 zoom">
                        <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                            ...
                            <div class="text-left">
                                <h4 class="w-100 text-black-50">Phone</h4>
                                <h3 class="text-success font-weight-bold d-flex align-items-center" id="TotalPhone">0</h3>
                            </div>
                            <div class="text-right">
                                <h4 class="w-100 text-black-50">WhatsApp</h4>
                                <h3 class="text-success font-weight-bold d-flex align-items-center" id="TotalWhatsApp">0</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 pr-lg-0">
                    <div class="card stretch-card mb-3 zoom">
                        <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                            ...
                            <div class="text-left">
                                <h4 class="w-100 text-black-50">Total</h4>
                                <form action="{{ route('Wl_RMA.index') }}" method="POST" id="totalAllRmaForm" style="display: inline-block;">
                                    <input type="hidden" name="_method" value="POST">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="daterange" id="Total_RMA_daterange">
                                    <input type="hidden" name="status" value="TotalRmaAll">
                                    <input type="hidden" name="fYear" id="Total_RmaYearID_daterange">
                                    <input type="hidden" name="fMonth" id="RMA_Month">
                                    <!--<a href="{{ route('Wl_RMA.index') }}">-->
                                    <a href="javascript:void(0);" onclick="document.getElementById('totalAllRmaForm').submit();">
                            ...
                            <div class="text-right">
                                <h4 class="w-100 text-black-50 pull-right">Open</h4>
                                <form action="{{ route('Wl_RMA.index') }}" method="POST" id="OpenAllRmaForm" style="display: inline-block;">
                                    <input type="hidden" name="_method" value="POST">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="daterange" id="Total_RMA_Open_daterange">
                                    <input type="hidden" name="status" value="TotalOpenRma">
                                    <input type="hidden" name="fYear" id="Total_RmaOpenYearID_daterange">
                                    <input type="hidden" name="fMonth" id="Open_RMA_Month">
                                    <a href="javascript:void(0);" onclick="document.getElementById('OpenAllRmaForm').submit();">
                                    <!--<a href="{{ route('Wl_RMA.index') }}">-->
            ...
            <?php }?>
            <div class="col-lg-3 col-md-6 @if (!in_array('50', \Session::get('menuList')) || !in_array('51', \Session::get('menuList')) || !in_array('52', \Session::get('menuList'))) {{ 'pr-lg-0' }} @endif">
                <div class="card stretch-card mb-3 zoom">
                    <div class="card-body analytic d-flex flex-wrap justify-content-between p-3">
                        <div class="row mb-1 w-115">
                            <div class="head">
...
@section('script')
    ...
    <script>
        function getdata() {
            ...
            const ticketListRoute = "{{ route('callList.index') }}";
            const monthMap = {
                        ...
                        /*var options = {
                            ...
                            onClick: function (evt, elements) {
                                if (elements.length > 0) {
                                    ...
                                    const monthLabel = barChart.data.labels[index];
                                    const month = monthMap[monthLabel];
                                    const year = $("#fYear").val();

                                    window.location.href =
                                        ticketListRoute + '?year=' + year + '&month=' + month;
                                }
                            },
                            elements: {
                                point: {
                            ...
                            options: {
                                scales: {
                                    yAxes: [{
                                        ticks: {
                                            beginAtZero: true,
                                            precision: 0,              // ðŸ‘ˆ integers only
                                            // callback: function(value) {
                                            //     return value + '%';   // ðŸ‘ˆ show % on axis
                                            // }
                                        }
                                    }]
                                },
        ...
        function getDashboardCount() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#TotalPhone").html(obj.totalPhone);
                    $("#TotalWhatsApp").html(obj.totalWhatsApp);
        ...
        $(document).ready(function() {
            ...
            if (month != "") {
                ...
                $("#Total_RMA_daterange").val(daterange);
                $("#Total_RMA_Open_daterange").val(daterange);
                $("#Total_RmaYearID_daterange").val(yearID);
                $("#Total_RmaOpenYearID_daterange").val(yearID);
                ...
                $("#Total_RMA_daterange").val('');
                $("#Total_RMA_Open_daterange").val('');
