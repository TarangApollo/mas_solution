...
@section('title', 'Download Call Report')
        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Download Call Report</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body p-0">
                        <h4 class="card-title mt-0">Download Call Report</h4>
                        <form class="was-validated p-4 pb-3" action="{{ route('downloadCall.download') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
    ...
    <!--<div class="content-wrapper pb-0">-->
        ...
        <div class="row d-flex justify-content-center mt-5">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body p-0">
                        <h4 class="card-title mt-0">Download RMA Report</h4>
                        <form class="was-validated p-4 pb-3" action="{{ route('rmaDownloadReport.download') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Select Date Range</label>
                                        <input type="text" class="form-control" id="datepickerNew" name="daterange" />
                                    </div>
                                </div> <!-- /.col -->
                            </div>
                            <button type="submit" class="btn btn-success text-uppercase pt-1 mb-3 mr-2"><i
...
$(function() {
    ...
    $('#datepickerNew').on('apply.daterangepicker', function(ev, picker) {
        $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format(
            'MM/DD/YYYY'));
    });
    $('#datepickerNew').on('cancel.daterangepicker', function(ev, picker) {
        $(this).val('');
    });
});
