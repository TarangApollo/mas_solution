                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <h4 class="card-title mt-0">search by categories</h4>
                             <form class="was-validated p-4 pb-3" action="{{ route('Wl_RMA.rma_month_summary') }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single" name="status" style="width: 100%;"
                                                ...
                                                <option
                                                    value="Open"{{ old('status', $status) == 'Open' ? 'selected' : '' }}>
                                                    Open</option>
                                                <option
                                                    value="Closed"{{ old('status', $status) == 'Closed' ? 'selected' : '' }}>
                                                    Closed</option>
                                                <option
                                                    value="Registered" {{ old('status', $status) == 'Registered' ? 'selected' : '' }}>
                                                    Registered</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single" name="fYear" style="width: 100%;">
                                                <option label="Please Select" value="">-- Select Financial Year --
                                                </option>
                                                @foreach ($yearList as $year)
                                                    <option value="{{ $year->iYearId }}" {{ old('fYear', $fYear) == $year->iYearId ? 'selected' : '' }}>{{ $year->yearName }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
