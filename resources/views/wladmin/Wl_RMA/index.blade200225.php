                        ...
                        <table id="fresh-table" class="table">
                            ...
                            <tbody>
                                @foreach ($rmsData as $key => $row)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $row->strCustomerEngineer ?? '-' }}</td>
                                        <td>{{ isset($row->strRMARegistrationDate) ? \Carbon\Carbon::parse($row->strRMARegistrationDate)->format('F') : '-' }}
                                        </td>
                                        ...
                                        <td>{{ $row->strStatus ?? '-' }}</td>
                                        <td>{{ $row->Factory_Status ?? '-' }}</td>
                                        <td>
                                            <a href="{{ route('Wl_RMA.rma_summary_info', $row->rma_id) }}" title="Info"
                                                class="table-action">
