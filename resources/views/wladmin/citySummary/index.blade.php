        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> City Summary </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        <form class="was-validated p-4 pb-3" action="{{route('citysummary.index' )}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                ...
                <div class="fresh-table toolbar-color-orange">
                    <table id="fresh-table" class="table">
                        <thead>
                            ...
                            <th data-field="project" data-sortable="true">PROJECT COUNT</th>
                            <th data-field="issues" data-sortable="true">COUNT OF ISSUES</th>
                            <th data-field="customercount">CUSTOMER COMPANY COUNT</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$ticket->projectCount}}</td>
                                <td>{{$ticket->issueCount}}</td>
                                <td>{{$ticket->compaycount}}</td>
                                <td>
                                    <!-- <a href="{{ route('citysummary.info',$ticket->iCityId) }}" title="Info" class="table-action">
                                        <i class="mas-info-circle"></i>
                                    </a> -->
                                    <form action="{{ route('citysummary.info') }}" method="POST" style="display: inline-block;">
                                        <input type="hidden" name="_method" value="post">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="iCityId" value="{{ $ticket->iCityId }}">
...
<?php  if (in_array('46', \Session::get('menuList')) ) { ?>
    <script type="text/javascript">
        var $table = $('#fresh-table'),full_screen = false;
            ...
            $('.mas-download').click(function(e) {
                ...
                if (table && table.length) {
                    $(table).table2excel({
                        ...
                        filename: "city_summary_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                        fileext: ".xls",
                        exclude_img: true,
                        exclude_links: false,
