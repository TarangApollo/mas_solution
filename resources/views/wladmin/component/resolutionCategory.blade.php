                                ...
                                <div class="accordion-box-content">
                                    <div class="tab-content clearfix">
                                        ...
                                        <div class="tab-pane fade in active" id="res-category">
                                            ...
                                            <form class="pb-3" name="frmparameter" id="frmparameter"
                                                action="{{ route('component.resolutioncategorycreatestore') }}"
                                                method="post">
                                                                                    ...
                                                                                    @foreach ($resolutionCategories as $resolutionCategory)
                                                                                        @if ($iCounter == 0)
                                                                                            <div class="form-group d-flex">
                                                                                                <input type="hidden"
                                                                                                    name="iResolutionCategoryId[]"
                                                                                                    value="{{ $resolutionCategory->iResolutionCategoryId ?? 0 }}">
                                                                                                <input type="text"
                                                                                                    class="form-control"
                                                                                                    name="field_name[]"
                                                                                                    value="{{ $resolutionCategory->strResolutionCategory }}">
                                                                                                <a href="javascript:void(0);"
                                                                                                    class="btn btn-success add_button add-more"
                                                                                                    title="Add Category"><i
                                                                                                        class="mas-plus-circle lh-normal"></i></a>
