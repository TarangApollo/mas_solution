                                                ...
                                                <div class="panel-body">
                                                    <ul class="accordion-tab nav nav-tabs">
                                                        <li class="active" id="generalLi">
                                                            <a onClick="generalLia();" href="{{ route('role.create') }}#general" @if (request()->routeIs('role.create')) {{ 'data-toggle="tab" '}} @endif >General</a>
                                                        </li>
                                                        <li id="permissionsLi">
                                                            <a href="{{ route('role.create') }}#permissions" @if (request()->routeIs('role.create')) {{ 'data-toggle="tab" aria-expanded="true"' }} @endif >Permissions</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="accordion-box-content">
                                    <div class="tab-content clearfix">
                                        <form class="was-validated pb-3" action="{{route('role.create')}}" method="post" name="frmparameter" id="frmparameter">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="role_name" name="role_name" value="" required>
                                                            ...
                                                            <div class="btn-group d-flex ml-4">
                                                                <div class="form-check mr-4">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="{{$submenulist['id']}}_1" id="{{$submenulist['id']}}_1" value="1" data-id="1"> Allow <i class="input-helper"></i></label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="{{$submenulist['id']}}_1" id="{{$submenulist['id']}}_2" value="0" data-id="2"> Deny <i class="input-helper"></i></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
