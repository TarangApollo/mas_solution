                                    ...
                                    <div class="tab-content clearfix">
                                        <div class="tab-pane fade in active" id="account">
                                            ...
                                            <form class="was-validated pb-3" name="frmparameter" id="frmparameter"
                                                ...
                                                <input type="hidden" name="iCompanyUserId" id="iCompanyUserId"
                                                    value="{{ $WlUser->iCompanyUserId }}">
                                                <input type="hidden" name="iUserId" id="iUserId"
                                                    value="{{ $WlUser->iUserId }}">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="js-example-basic-single"
                                                                                        ...
                                                                                        @foreach ($Roles as $role)
                                                                                            <option
                                                                                                value="{{ $role->id }}"
                                                                                                @if ($WlUser->iRoleId == $role->id) {{ 'selected' }} @endif>
                                                                                                {{ $role->name }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        {{ isset($User->isCanSwitchProfile) && $User->isCanSwitchProfile == 1 ? 'checked' : null }}>
                                                                                    Switch
                                                                                    User
