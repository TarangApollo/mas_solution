...
<div class="content-wrapper pb-0">
    ...
    <div class="row">
        <div class="col-md-12 d-flex justify-content-end">
            <a href="{{ route('companyclient.uploadindex') }}">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="ownerphone[]" id="contact" class="form-control"  onkeypress="return isNumber(event)" value="{{$id!=0? $CompanyClient->ownerphone:''}}">
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="js-example-basic-single" name="iCompanyClientProfileId[]" id="iCompanyClientProfileId" style="width: 100%;">
                                                                                    ...
                                                                                    <option value="{{ $ClientProfile->iCompanyClientProfileId }}" {{($id!=0 && $CompanyClient->iCompanyClientProfileId == $ClientProfile->iCompanyClientProfileId )? 'selected':''}}>{{ $ClientProfile->strCompanyClientProfile }} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div> <!-- /.form-group -->
                                                                        </div> <!-- /.col -->
