<?php
    ...
    $file = file_get_contents($root."/mailers/ticket-update.html", "r");

    $file = str_replace("#CompanyName#",$data['CompanyName'] ,$file);
    $file = str_replace("#CustomerCompanyName#",$data['CustomerCompanyName'] ,$file);
    
    $file = str_replace("#Message#",$data['Message'],$file);
    $file = str_replace("#TicketID#",$data['TicketID'],$file);
    $file = str_replace("#TicketStatus#",$data['TicketStatus'],$file);

    $file = str_replace("#CustomerName#",$data['CustomerName'],$file);
    $file = str_replace("#CustomerNumber#",$data['CustomerMobile'],$file);
    $file = str_replace("#TicketOpenDate#",$data['TicketOpenDate'],$file);

    $file = str_replace("#CompanyEmail#",$data['CompanyEmail'],$file);
    $file = str_replace("#CompanyMobile#",$data['CompanyMobile'],$file);
