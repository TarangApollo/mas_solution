<?php
    ...
    if($data['supportEmail'] != ""){
        $file = str_replace("#CompanyEmail#",$data['supportEmail'] ,$file);
    } else {
        $file = str_replace("#CompanyEmail#","support@masolutions.co.in" ,$file);
    }
    if($data['ContactNo'] != ""){
        $file = str_replace("#CompanyMobile#",$data['ContactNo'],$file);
    }else{
        $file = str_replace("#CompanyMobile#",'IN (+91) 456 7891 224',$file);
    }
    echo $file;
