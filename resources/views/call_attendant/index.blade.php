...
@section('content')
    ...
    <div class="container-fluid page-body-wrapper">
        <div class="main-panel">
            <div class="content-wrapper pb-0">
                        ...
                        <div class="header-right d-flex flex-wrap mt-sm-5 mt-lg-0">
                            <div class="d-flex align-items-center">
                                <a class="border-0" href="#">
                                    <h3 class="m-0">Add New Complaint</h3>
                                </a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-4" id="otherCompanyProfileDiv"
                                                            style="display: none;">
                                                            <div class="form-group">
                                                        ...
                                                        @if(isset($CompanyMaster[0]->iAllowedCallCount) && $CompanyMaster[0]->iAllowedCallCount == 0)
                                                            <div class="col-lg-3 col-md-4">
                                                                <div class="form-group">
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="col-lg-3 col-md-4" id="divPhoneCount">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text"
                                                                        style="width: 100%;" name="iPhoneCount"
                                                            ...
                                                            <div class="col-lg-3 col-md-4" id="divWhatsAppCount">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text"
                                                                        style="width: 100%;" name="iWhatsAppCount"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-4" id="iSubComponentIdDiv">
                                                            <div class="form-group">
                ...
                if($Company_Master->iAllowedCallCount == 0){
                    ...
                    if (empty($selectedOptions)) {
                        ...
                        $options = ['NO', 'ID', 'STATUS','CALL COUNT', 'CONTACT NAME', 'CONTACT NO', 'OEM COMPANY', 'COMPANY NAME','PROJECT', 'SYSTEM', 'COMPONENT', 'SUB COMPONENT', 'SOLUTION TYPE', 'COMPLAINT DATE', 'RESOLVED DATE', 'ISSUE', 'ATTENDANT','ACTIONS'];
                        $optionLabels = [
                            'NO' => 'No',
                            'ID' => 'ID',
                            'STATUS' => 'Status',
                            ...
                            <table id="fresh-table" class="table"
                                ...
                                <thead>
                                    ...
                                    foreach ($selectedOptions as $option) {
                                        ...
                                        echo "<th data-field=\"{$option}\" data-sortable=\"true\">{$label}</th>";
                                    }
                                    ?>
                                </thead>

                                <tbody id="myticket_List">
                                </tbody>
                            </table>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#iCall_Through').on('change', function () {
                toggleCounts();
            });
        });
    </script>
