                                            ...
                                            <table class="table table-striped" data-role="content"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ws-break"> {{ $rmaList->strItemDescription ?? '-' }} </td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td>
                                                        <td>Serial No</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ws-break">{{ $rmaList->strFaultdescription ?? '-' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>11</td>
                                                        <td>Facts</td>
                                                        <td class="ws-break">{{ $rmaList->strFacts ?? '-' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>12</td>
                                                        <td>Additional Details</td>
                                                        <td class="ws-break">{{ $rmaList->strAdditionalDetails ?? '-' }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
