                                                        ...
                                                        <div class="col-lg-3 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="iRMANumber" class="form-control"
                                                                    id="iRMANumber" value="" readonly disabled/>
                                                            </div>
                                                        </div> <!-- /.col -->
                                                        <div class="col-lg-3 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="strCustomerCompany"
                                                                    ...
                                                                    value="{{ old('strCustomerCompany') }}" readonly disabled/>
                                                            </div>
                                                        </div> <!-- /.col -->
                                                        <div class="col-lg-3 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('strCustomerEngineer') }}" readonly disabled/>
                                                            </div>
                                                        </div> <!-- /.col -->
                                                        <div class="col-lg-3 col-md-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-lg-3 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('strProjectName') }}" readonly disabled/>
                                                            </div>
                                                        </div> <!-- /.col -->
                                                        <div class="col-lg-3 col-md-4">
