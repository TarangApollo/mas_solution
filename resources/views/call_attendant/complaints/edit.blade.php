                                    ...
                                    <div class="row bg-orange bg-opacity-25 p-4">
                                        <div class="col-md-6 font-15">
                                            <div class="row">
                                                ...
                                                @else
                                                    <div class="col-lg-8 col-md-12 col-xs-6 mb-2">
                                                        @if(isset($CompanyCallCount->iPhoneStatus) && $CompanyCallCount->iPhoneStatus == 1)
                                                            Phone Count: {{ $CompanyCallCount->iPhoneCount }}
                                                        @endif
                                                        @if(isset($CompanyCallCount->iWhatsAppStatus) && $CompanyCallCount->iWhatsAppStatus == 1)
                                                            <br /> WhatsApp Count: {{ $CompanyCallCount->iWhatsAppCount }}
                                                        @endif
                                                    </div>
                                                @endif
