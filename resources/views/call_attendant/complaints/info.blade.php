                                            ...
                                            <table class="table table-striped" data-role="content" data-plugin="selectable"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @else
                                                        <td>
                                                            @if(isset($CompanyCallCount->iPhoneStatus) && $CompanyCallCount->iPhoneStatus == 1) Phone Count: {{ $CompanyCallCount->iPhoneCount ?? 0 }} @endif
                                                            @if(isset($CompanyCallCount->iWhatsAppStatus) && $CompanyCallCount->iWhatsAppStatus == 1) <br /> WhatsApp Count: {{ $CompanyCallCount->iWhatsAppCount ?? 0 }} @endif</td>
                                                        @endif
                                                    </tr>
                                                    <tr>
                                                        <td>15</td>
                                                        <td>User Defined</td>
                                                        <td class="ws-break">{{ $ticketInfo->UserDefiine1 }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>16</td>
                                                        <td>Project</td>
                                                        <td class="ws-break">{{ $ticketInfo->ProjectName }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>17</td>
                                                        <td>Project State</td>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single"
                                                style="width: 100%;" name="iCall_Through[]"
                                                id="iCall_Through" multiple>
                                                <option value="Phone" @if(isset($CompanyCallCount->iPhoneStatus) && $CompanyCallCount->iPhoneStatus == 1) selected @endif>Phone</option>
                                                <option value="Whatsapp" @if(isset($CompanyCallCount->iWhatsAppStatus) && $CompanyCallCount->iWhatsAppStatus == 1) selected @endif>Whatsapp</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-4" id="divPhoneCount">
                                        <div class="form-group">
                                            <label>Phone Count</label>
                                            <input class="form-control" type="text"
                                                style="width: 100%;" name="iPhoneCount" value="{{ $CompanyCallCount->iPhoneCount ?? 0 }}"
                                                id="iPhoneCount" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        </div>
                                    </div> <!-- /.col -->
                                    <div class="col-lg-3 col-md-4" id="divWhatsAppCount">
                                        <div class="form-group">
                                            <label>WhatsApp Count</label>
                                            <input class="form-control" type="text"
                                                style="width: 100%;" name="iWhatsAppCount" value="{{ $CompanyCallCount->iWhatsAppCount ?? 0 }}"
                                                id="iWhatsAppCount" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        </div>
                                    </div> <!-- /.col -->
                                @endif
                                <div class="col-lg-3 col-md-4">
...
<script>
        $(document).ready(function () {
            ...
            // Initialize Select2
            $('#iCall_Through').select2({
                placeholder: "-- Select --",
                allowClear: true
            });

            function toggleCounts() {
                let selected = $('#iCall_Through').val() || [];
                
                // Normalize values
                selected = selected.map(v => $.trim(v).toLowerCase());

                // Hide both boxes first
                $('#divPhoneCount').hide();
                $('#divWhatsAppCount').hide();

                // If no selection → hide all
            ...
            // Run on change
            $('#iCall_Through').on('change', toggleCounts);
        });
    </script>
    <!-- plugins:js -->
