                                    ...
                                    @if (count($ticketList) > 0)
                                        @foreach ($ticketList as $ticket)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('complaint.info', $ticket->iTicketId) }}" title="Info" class="table-action fs-6 text-secondary text-decoration-underline">
                                                        <?= isset($ticket->strTicketUniqueID) && $ticket->strTicketUniqueID != "" ? $ticket->strTicketUniqueID : str_pad($ticket->iTicketId, 4, '0', STR_PAD_LEFT) ?>
                                                    </a>
                                                </td>
                                                <?php } ?>
