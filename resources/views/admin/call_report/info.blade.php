                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped" data-role="content" data-plugin="selectable"
                                        ...
                                        @if($ticketInfo->iAllowedCallCount == 0)
                                        <tr>
                                            <td>14</td>
                                        ...
                                        <tr>
                                            <td>14</td>
                                            <td>Call Connected Through</td>
                                            <td>@if(isset($ticketInfo->iPhoneStatus) && $ticketInfo->iPhoneStatus == 1) Phone Count: {{ $ticketInfo->iPhoneCount ?? 0 }} @endif
                                                @if(isset($ticketInfo->iWhatsAppStatus) && $ticketInfo->iWhatsAppStatus == 1) <br /> WhatsApp Count: {{ $ticketInfo->iWhatsAppCount ?? 0 }} @endif</td>
                                        </tr>
                                        @endif
                                        <tr>
                                            <td>15</td>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($tickethistory as $history)
                                                <tr>
                                                    ...
                                                    <td>{{ $history['user'] }} @if(isset($history['TicketAssignTo']) && $history['TicketAssignTo'] != "") <br /> <small class="position-static">{{ "Assign to : " . $history['TicketAssignTo'] }}</small> @endif</td>
                                                </tr>
                                                <?php $iCounter++; ?>
                                            @endforeach
