                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    ...
                                    <div class="tab-pane fade in active" id="support">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{route('company.supporttypestore')}}" method="post">
                                                                    ...
                                                                    <td>
                                                                        <div class="col-md-9 field_wrapper">
                                                                            ...
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iSuppotTypeId[]" value="0">
                                                                                <input type="text" class="form-control" name="field_name[]">
                                                                                <a href="javascript:void(0);" class="btn btn-success add_button add-more" title="Add Support Type"><i class="mas-plus-circle lh-normal"></i></a>
                                                                            </div>
                                                                            @else
                                                                            <?php $iCounter = 0; ?>
                                                                            ...
                                                                            @if($iCounter == 0)
                                                                            <div class="form-group d-flex">
                                                                                <input type="hidden" name="iSuppotTypeId[]" value="{{ $supporttype->iSuppotTypeId ?? 0 }}">
                                                                                <input type="text" class="form-control" name="field_name[]" value="{{ $supporttype->strSupportType }}">
                                                                            ...
                                                                            @endif
                                                                            <!-- <div class="form-group d-flex">
                                                                                    <input type="text" class="form-control" value="Commission Support">
                                                                                    <a href="javascript:void(0);" class="btn btn-danger remove_button add-more" title="Delete Support Type"><i class="mas-minus-circle lh-normal"></i></a>
                                                                                </div>

                                                                                <div class="form-group d-flex">
                                                                                    <input type="text" class="form-control" value="Knowledge Support">
                                                                                    <a href="javascript:void(0);" class="btn btn-danger remove_button add-more" title="Delete Support Type"><i class="mas-minus-circle lh-normal"></i></a>
                                                                                </div> -->
                                                                        </div>
                                                                    </td>
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('company.supporttypestore')}}",
            ...
            success: function(response) {
                ...
                if (response > 0) {
                    $('#loading').css("display", "none");
                    $("#successalert").show();
                    $("#msgdata").html("<strong>Success !</strong> Support Type Created Successfully.");
                    ...
                    // url = url.replace('?', '/');
                    var url = "{{route('company.support-type',':company_id')}}";
                    url = url.replace(':company_id', company_id);
                    url = url.replace('?', '/');
