                                        ...
                                        <div id="role_information" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <ul class="accordion-tab nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('distributor.edit',$id) }}">Basic Information</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('distributor.salesedit',$id) }}" >Sales Person</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('distributor.technicaledit',$id) }}">Technical Person</a>
                                                    </li>
                                                    <li class="active">
                            ...
                            <div class="accordion-box-content">
                                <div class="tab-content clearfix">
                                    ...
                                    <div class="" id="account">
                                        ...
                                        <form class="was-validated pb-3" name="frmparameter" id="frmparameter" action="{{ route('distributor.userdefinedstore') }}" method="post">
                                            @csrf
...
<script>
    $('#submit').on("click", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{route('distributor.userdefinedstore')}}",
