                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($tickethistory as $history)
                                                        <tr>
                                                            ...
                                                            <td class="ws-break">{{ $history['user'] }} @if(isset($history['TicketAssignTo']) && $history['TicketAssignTo'] != "") <br /> <small>{{ "Assign to : " . $history['TicketAssignTo'] }}</small> @endif</td>
                                                        </tr>
                                                        <?php $iCounter++; ?>
                                                    @endforeach
                                                                ...
                                                                @foreach ($Detail->gallery as $index => $gallery)
                                                                    @if ($gallery->DocumentType == 2)
                                                                        <div
                                                                            ...
                                                                            <div class="text-center del-img mt-2">
                                                                                <form
                                                                                    action="{{ route('callList.delete', $Detail->iTicketDetailId) }}"
                                                                                    method="POST"
                                                                                    onsubmit="return confirm('Are you Sure You wanted to Delete?');"
                                                                                    style="display: inline-block;">
                                                                                    <input type="hidden" name="_method"
