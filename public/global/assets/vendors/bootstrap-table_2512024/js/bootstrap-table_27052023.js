...
! function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        icons: {
            ...
            download: 'glyphicon-download icon-download',
        ...
        onDownloadOptions: function (options) {
            return false;
        },
    ...
    BootstrapTable.EVENTS = {
        ...
        'download-options.bs.table': 'onDownloadOptions',
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        // showColumns, showToggle, showRefresh, download
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn" type="button" name="paginationSwitch" title="%s">',
        ...
        if (this.options.showDownload) {
            html.push(sprintf('<button class="btn' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="download" title="%s">',
                    this.options.formatDownload()),
                sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.download),
                '</button>');
        }

        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" class="btn' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
        ...
        if (this.options.showDownload) {
            this.$toolbar.find('button[name="download"]')
                .off('click').on('click', $.proxy(this.download, this));
        }
    ...
    BootstrapTable.prototype.download = function (params) {
    ...
    BootstrapTable.prototype.downloadOptions = function (options) {
        //If the objects are equivalent then avoid the call of destroy / init methods
        if (compareObjects(this.options, options, false)) {
            return;
        }
        this.options = $.extend(this.options, options);
        this.trigger('download-options', this.options);
        this.destroy();
        this.init();
    };
