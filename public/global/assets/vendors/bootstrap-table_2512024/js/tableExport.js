...
(function ($) {
    $.fn.tableExport = function (options) {
        ...
        const defaults = {
            ...
            jspdf: {
                ...
                autotable: {
                    ...
                    tableExport: { doc: null, onAfterAutotable: null, onBeforeAutotable: null, onAutotableText: null, onTable: null, outputImages: true },
                },
            },
            mso: {
                fileFormat: "xlshtml",
                ...
                styles: [],
                worksheetName: "",
                xlsx: { formatId: { date: 14, numbers: 2, currency: 164 }, format: { currency: "$#,##0.00;[Red]-$#,##0.00" }, onHyperlink: null },
            },
            ...
            pdfmake: {
                ...
                docDefinition: {
                    pageSize: "A4",
                    pageOrientation: "portrait",
                    styles: { header: { background: "#34495E", color: "#FFFFFF", bold: true, alignment: "center", fillColor: "#34495E" }, alternateRow: { fillColor: "#f5f5f5" } },
        ...
        const jsPdfThemes = {
            striped: { table: { fillColor: 255, textColor: 80, fontStyle: "normal", fillStyle: "F" }, header: { textColor: 255, fillColor: [41, 128, 185], rowHeight: 23, fontStyle: "bold" }, body: {}, alternateRow: { fillColor: 245 } },
            grid: {
                ...
                $(el)
                    ...
                    .each(function () {
                        ...
                        docDefinition.content.push({
                            table: { headerRows: $head_rows.length ? $head_rows.length : null, widths: widths, body: body },
                            layout: {
                                layout: "noBorders",
            ...
            if (isVisible($cell)) {
                if (defaults.ignoreColumn.length > 0) {
                    if (
                        ...
                        (colNames.length > colIndex && typeof colNames[colIndex] !== "undefined" && $.inArray(colNames[colIndex], defaults.ignoreColumn) !== -1)
                    )
                        result = true;
                }
            } else result = true;
                            ...
                            if (number !== false) {
                                ...
                                result =
                                    ...
                                    (defaults.numbers.output.thousandsSeparator
                                        ? (mod ? frac[0].substr(0, mod) + defaults.numbers.output.thousandsSeparator : "") + frac[0].substr(mod).replace(/(\d{3})(?=\d)/g, "$1" + defaults.numbers.output.thousandsSeparator)
                                        : frac[0]) +
        ...
        function getCellStyles(cell) {
            ...
            if (f === "") f = "normal";
            const result = {
                style: { align: a, bcolor: rgb2array(getStyle(cell, "background-color"), [255, 255, 255]), color: rgb2array(getStyle(cell, "color"), [0, 0, 0]), fstyle: f },
        ...
        function jsPdfAutoTable(doc, headers, data, options) {
            ...
            const userStyles = { textColor: 30, fontSize: jsPdfDoc.internal.getFontSize(), fontStyle: jsPdfDoc.internal.getFont().fontStyle, fontName: jsPdfDoc.internal.getFont().fontName };
